...
{
    /// <summary>
    ///     This transform takes a univariate price series as input, and converts it to open-high-low-close values over the
    ///     specified intervals.
    /// </summary>
    [Serializable]
    public class OHLCBarBuilder : TimeSeriesTransformation
    {
        [NonSerialized] private MVTimeSeries combined;
