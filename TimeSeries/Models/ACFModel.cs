...
namespace CronoSeries.TimeSeries.Models
{
    ...
    public class ACFModel : UnivariateTimeSeriesModel, IMLEEstimable, IRealTimePredictable //, IExtraFunctionality
    {
        ...
        public virtual void Register(Data.TimeSeries series)
        {
        ...
        public override object BuildForecasts(object otherData, object inputs)
        {
            ...
            var startData = otherData as Data.TimeSeries;
            if (startData == null)
        ...
        /// <returns></returns>
        private TimeSeriesBase<DistributionSummary> GetForecasts(Data.TimeSeries startData, IList<DateTime> futureTimes)
        {
        ...
        protected double[] ComputeSpecialResiduals(Data.TimeSeries startData, out double[] rs, int forecastHorizon,
